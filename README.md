...
Usage: ./RationalRotation [OPTIONS] 1
...
Options:
  ...
  -p,--precision FLOAT=1e-06            Precision approximation (default 1e-6)
...
./RationalRotation -d 2 -i ../ball_r5.pgm -a 45 -p 0.00001

./RationalRotation -d 3 -i ../Al.100.vol --qa 3 --qb 4 --qc 5 --qd 6

./RationalRotation -d 3 -i ../Al.100.vol -a 45 --ax 1 --ay 2 --az 3

./RationalRotation -d 3 -i ../Al.100.vol -a 45 --ax 1 --ay 2 --az 3 -p 0.00001
